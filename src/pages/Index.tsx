      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex gap-4">
            <Button
              size="lg"
              className="bg-[#9b87f5] hover:bg-[#8371e0] text-white"
            >
              Каталог
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-10">
          <Icon
            name="ChevronDown"
            className="text-white animate-bounce h-8 w-8"
          />
        </div>
      </div>
          ...
          {categories.map((category, index) => (
            ...
            >
              <div className="bg-[#1A1F2C] aspect-square rounded-lg flex flex-col items-center justify-center text-white transition-transform hover:scale-105">
                <Icon
                  name={category.icon}
                  className="h-12 w-12 mb-3 group-hover:text-[#9b87f5] transition-colors"
                />
                      ...
                      <div className="relative group cursor-pointer">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 opacity-90">
                          ...
                          <div className="flex justify-between items-center mt-2">
                            ...
                            >
                              <Icon name="Plus" className="h-4 w-4 mr-1" />В
                              корзину
                            </Button>
                          </div>
                        </div>
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="text-lg mb-4">
            Мы создаем мебель в стиле лофт, используя долговечные материалы и
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 -left-6 bg-[#1A1F2C] text-white p-6 rounded-lg max-w-xs shadow-xl hidden md:block">
            <div className="flex items-center mb-3">
              <Icon
                name="Star"
                className="h-5 w-5 text-[#F97316] mr-1 fill-[#F97316]"
              />
              <Icon
                name="Star"
                className="h-5 w-5 text-[#F97316] mr-1 fill-[#F97316]"
            ...
            <p className="italic">
              "Качество и стиль на высшем уровне! Заказывали обеденный стол и
              стеллаж — все идеально подошло под наш интерьер."
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-gray-400">
              Создаем эксклюзивную мебель в стиле лофт с 2015 года.
            </p>
